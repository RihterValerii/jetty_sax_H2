...
public class SaxService {
    ...
    public SaxService(long date) {
        SaxService.date = date;
    }

    public List<Job> parseRequest(String request) throws ParserConfigurationException, SAXException, IOException {
